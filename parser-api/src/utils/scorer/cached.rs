...
impl CachedPostFeatures {
    ...
    pub fn from_post_with_user(
        ...
        Self {
            ...
            score_total: post.stats.score.total,
            score_up: post.stats.score.up,
            score_down: post.stats.score.down,
            fav_count: post.stats.fav_count,
            comment_count: post.stats.comment_count,
            duration: post.files.meta.duration.unwrap_or(0.0) as f32,
