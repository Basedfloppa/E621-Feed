...
async fn build_rocket() -> rocket::Rocket<rocket::Build> {
    ...
    let (api_routes, spec) = openapi_get_routes_spec![
        ...
        routes::account::set_account_key,
        routes::account::test_account_key,
        routes::account::delete_account_key,
        routes::account::get_account_key_state,
        routes::account::sync_account_route,
        routes::account::get_sync_status,
